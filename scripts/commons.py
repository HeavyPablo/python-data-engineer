...
REDSHIFT_HOST = env["AWS_REDSHIFT_HOST"]
REDSHIFT_PORT = env["AWS_REDSHIFT_PORT"]
REDSHIFT_DB = env["AWS_REDSHIFT_DATABASE"]
REDSHIFT_USER = env["AWS_REDSHIFT_USER"]
REDSHIFT_SCHEMA = env["AWS_REDSHIFT_SCHEMA"]
REDSHIFT_PASSWORD = env["AWS_REDSHIFT_PASSWORD"]
